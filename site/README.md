...
highlights:
  - header: 东师指南
    ...
    features:
      - title: 入学准备
        icon: https://mp.innenu.com/res/icon/prepare.svg
        link: ./guide/prepare/

      - title: 找到组织
        icon: https://mp.innenu.com/res/icon/qq-group.svg
        link: ./guide/contact/

      - title: 新生入学教育
        icon: https://mp.innenu.com/res/icon/study.svg
        link: ./guide/yiban/

      - title: 需带物品
        icon: https://mp.innenu.com/res/icon/necessity.svg
        link: ./guide/necessity/

      - title: 到校路线
        icon: https://mp.innenu.com/res/icon/locate.svg
        link: ./guide/arrival/

      - title: 新生报到
        icon: https://mp.innenu.com/res/icon/check.svg
        link: ./guide/check/

      - title: 入学活动
        icon: https://mp.innenu.com/res/icon/activity.svg
        link: ./guide/activity/

      - title: 常见问题
        icon: https://mp.innenu.com/res/icon/faq.svg
        link: ./guide/faq/
      ...
      - title: 校园卡
        icon: https://mp.innenu.com/res/icon/card.svg
        link: ./guide/card/
      ...
      - title: 学费缴纳
        icon: https://mp.innenu.com/res/icon/money.svg
        link: ./guide/pay/

      - title: 保险
        icon: https://mp.innenu.com/res/icon/insurance.svg
        link: ./guide/insurance/

      - title: 规章制度
        icon: https://mp.innenu.com/res/icon/rule.svg
        link: ./intro/rule/

      - title: 常见服务
        icon: https://mp.innenu.com/res/icon/service.svg
        link: ./guide/action/

      - title: 寝室
        icon: https://mp.innenu.com/res/icon/dorm.svg
        link: ./guide/dorm/

      - title: 食堂
        icon: https://mp.innenu.com/res/icon/dining.svg
        link: ./guide/dining/

      - title: 快递
        icon: https://mp.innenu.com/res/icon/express.svg
        link: ./guide/express/

      - title: 超市
        icon: https://mp.innenu.com/res/icon/shop.svg
        link: ./guide/shop/

      - title: 洗浴
        icon: https://mp.innenu.com/res/icon/bath.svg
        link: ./guide/bath/

      - title: 生活
        icon: https://mp.innenu.com/res/icon/life.svg
        link: ./guide/life/

      - title: 统一身份认证
        icon: https://mp.innenu.com/res/icon/authorize.svg
        link: ./guide/account/authorize/

      - title: 校园邮箱
        icon: https://mp.innenu.com/res/icon/email.svg
        link: ./guide/account/mail/

      - title: 企业号
        icon: https://mp.innenu.com/res/icon/wechat.svg
        link: ./guide/account/wechat/

      - title: 教务系统
        icon: https://mp.innenu.com/res/icon/system.svg
        link: ./guide/system/

      - title: 选课系统
        icon: https://mp.innenu.com/res/icon/select.svg
      ...
      - title: 转专业
        icon: https://mp.innenu.com/res/icon/change.svg
        link: ./guide/change-major/

      - title: 师范生
        icon: https://mp.innenu.com/res/icon/teacher.svg
        link: ./guide/normal/
      ...
      - title: 奖学金
        icon: https://mp.innenu.com/res/icon/metal.svg
      ...
      - title: 图书馆
        ...
        link: ./guide//intro/apt/library/

      - title: 校内考试
        icon: https://mp.innenu.com/res/icon/test.svg
        link: ./guide/test/

      - title: 国家考试
        icon: https://mp.innenu.com/res/icon/exam.svg
        link: ./guide/exam/
      ...
      - title: 优秀毕业生建议
        icon: https://mp.innenu.com/res/icon/idea.svg
        link: ./guide/advice/
      ...
      - title: 交通出行
        icon: https://mp.innenu.com/res/icon/traffic.svg
        link: ./guide/traffic/

      - title: 数码产品
        icon: https://mp.innenu.com/res/icon/digital.svg
        link: ./guide/tip/digital

      - title: 学生组织
        icon: https://mp.innenu.com/res/icon/student-org.svg
        link: ./guide/organization/

      - title: 社团
        icon: https://mp.innenu.com/res/icon/association.svg
        link: ./guide/association/

      - title: 吃喝玩乐
        icon: https://mp.innenu.com/res/icon/nearby.svg
